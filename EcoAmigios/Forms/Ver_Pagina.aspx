                    ...
                    <asp:DataList ID="DataListPublicaciones" runat="server" DataSourceID="SqlDataSourcePublicaciones" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Left" Font-Names="Comic Sans MS" Font-Size="Large" Width="868px">
                        ...
                        <ItemTemplate>
                            ...
                            <table class="auto-style6">
                                ...
                                <br />
                                <tr>
                                    <td rowspan="2"><asp:Image ID="ImagePagina" runat="server" CssClass="imagen" height="120" ImageUrl='<%# "~/Imagenes/"+Eval("Img_Publi") %>' width="140" /></td>
                                    <td> Titulo:
                                    <asp:Label ID="Titulo_PubliLabel" runat="server" Text='<%# Eval("Titulo") %>' /></td>
                                </tr>
                                <tr>
                                    <br />
                                    <td><asp:Label ID="ContenidoPubliLabel" runat="server" Text='<%# Eval("Contenido") %>' /></td>
                                </tr>
                            </table>
                        </ItemTemplate>
                    </asp:DataList>
